...
- **Sprint 6**: Khắc phục lỗi Facebook Pages `CreatePostWithPhotos` trên Make.com: Đã chuyển toàn bộ file ảnh media tĩnh vào thư mục `public/`, bổ sung thuộc tính `type: 'url'` cho mảng `facebook_photos` để khớp 100% schema validation của Make.com.
